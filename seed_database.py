...
sample_gear = {
    "jetboil": {"name": "jetboil", "item": "stove"},
    "half dome 2": {"name": "half dome 2", "item": "tent"},
    "petzel 2 grigri": {"name": "petzel 2 grigri", "item": "belay device"},
    "nanopuff": {"name": "nanopuff", "item": "jacket"},
}
